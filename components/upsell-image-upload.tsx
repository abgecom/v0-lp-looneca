...
/**
 * Upload de fotos do pet com compressão client-side, usado na página de
 * upsell pós-compra. Envia para a mesma rota genérica /api/upload (Vercel
 * Blob) já usada no formulário principal de personalização.
 */
export default function UpsellImageUpload({ onImagesUploaded, quantidadePets }: UpsellImageUploadProps) {
