...
export async function POST(req: NextRequest) {
  const planData = {
    name: "Petloo Trimestral + 2 Tags - 30 Dias Grátis",
    description: "Assinatura trimestral com 2 tags e 30 dias grátis de teste",
    interval: "month",
    interval_count: 3,
    ...
    items: [
      {
        name: "Petloo Trimestral + 2 Tags",
        quantity: 1,
        pricing_scheme: {
          price: 10200, // R$ 102,00 em centavos
        },
      },
    ],
  }
